...
fun BottomNavigationBar(navController: NavController, authPreferences: AuthPreferences) {
    ...
    NavigationBar(
        ...
        Row(
            ...
            items.forEach { item ->
                val isSelected = if (item.route == "patient_dashboard") {
                    currentDestination?.startsWith("patient_dashboard") == true
                } else {
                ...
                Box(
                    modifier = Modifier
                        ...
                        .clickable {
                            ...
                            val route = if (item.route == "patient_dashboard") {
